          ...
          <div className="flex-1 relative max-h-[450px] md:max-h-[500px]" style={{ perspective: '1500px' }}>
            ...
            >
              {portfolio.map((project, index) => (
                ...
                >
                  <div className="bg-white dark:bg-white/10 dark:backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl dark:shadow-2xl border border-gray-200 dark:border-white/20 transition-all duration-300 hover:border-purple-400 dark:hover:border-purple-400">
